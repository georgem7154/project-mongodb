    ...
    <div className="z-40 h-36 top-0 w-full fixed border-2 dark:border-0 max-md:hidden dark:bg-slate-900 dark:text-white bg-white">
      <div className="container mx-auto flex justify-between items-center h-full">
        ...
        <div className="font-montserrat flex font-semibold text-2xl justify-between mr-36 w-7/12 flex-row">
          <button
            className="shadow-sm hover:shadow-md dark:bg-pink-400 dark:text-white dark:hover:text-red-500 dark:hover:bg-white hover:shadow-black shadow-slate-800 bg-red-100 py-3 hover:bg-red-200 hover:scale-110 transition ease-in-out px-10 justify-center rounded-full"
            onClick={handleScrollToBook} // Updated to scroll to the Book section
          >
            {blogItems[1]}
          </button>
          ...
          <button
            className="shadow-sm hover:shadow-md dark:bg-pink-400 dark:text-white dark:hover:text-red-500 dark:hover:bg-white hover:shadow-black shadow-slate-800 bg-green-100 py-3 hover:bg-red-200 hover:scale-110 transition ease-in-out px-3 justify-center rounded-full"
